        ...
        <>
          ...
          <div className="content-margined">
            ...
            <ul className="review" id="reviews">
              {console.log(product.reviews, userInfo)}
              {product.reviews.map((review) => (
                <li key={review._id}>
                  {userInfo ? review.reviewerId === userInfo._id ? (isReviewRated = true) : console.log(review.reviewerId, userInfo._id) : ""}
                  <div>{review.name}</div>
                  <div>
              ...
              <li>
                ...
                {userInfo ? !isReviewRated ? (
                  <>
                    <button className="button" onClick={()=> setIsModalDisplay(true)}>Add a Review</button>
                    {isModalDisplay && (
                      <Modal closeHandler={modalCloseHandler}>
                        <center><h3>Customer Review</h3></center>
                ...
                ) : "Review for this product is already rated by you." : (
                  <div>
